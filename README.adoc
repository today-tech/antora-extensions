= today-tech.cn Antora Extensions
...
:url-project: https://github.com/today-tech/antora-extensions
...
This library provides Antora extensions that support the TODAY documentation.
...
Use the following command to install the @today-tech/antora-extensions package into your project:

[,console]
----
$ npm i @today-tech/antora-extensions
----
...
*require name:* @today-tech/antora-extensions/inject-collector-cache-config-extension
...
*require name:* @today-tech/antora-extensions/latest-version-extension
...
*require name:* @today-tech/antora-extensions/partial-build-extension
...
*require name:* @today-tech/antora-extensions/publish-docsearch-config-extension
...
*require name:* @today-tech/antora-extensions/root-component-extension
...
*require name:* @today-tech/antora-extensions/tabs-migration-extension

IMPORTANT: Be sure to register this extension under the `antora.extensions` key in the playbook, not the `asciidoc.extensions` key!

The purpose of this extension is to migrate the AsciiDoc source from using TODAY tabs to using https://github.com/asciidoctor/asciidoctor-tabs[Asciidoctor tabs].
...
*require name:* @today-tech/antora-extensions/static-page-extension

IMPORTANT: Be sure to register this extension under the `antora.extensions` key in the playbook, not the `asciidoc.extensions` key!

This extension adds shared pages that are picked up by the antora-ui-today project.

=== Asciinema

*require name:* @today-tech/antora-extensions/asciinema-extension
